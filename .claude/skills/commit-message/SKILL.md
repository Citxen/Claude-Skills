---
name: commit-message
description: Generates conventional commit messages by analysing staged git changes. Use when the user asks to commit, write a commit message, or mentions git commits
